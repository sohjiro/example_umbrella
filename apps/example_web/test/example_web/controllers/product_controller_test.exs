defmodule ExampleWeb.ProductControllerTest do
  use ExampleWeb.ConnCase

  alias Example.Products

  @create_attrs %{brand: "some brand", description: "some description", image: "some image", name: "some name", stock: 42, unit_price: 120.5}
